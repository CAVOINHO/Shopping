...
<html lang="en">
	<head>
	    ...
	    <!-- Bootstrap Core CSS -->
	    <link rel="stylesheet" href="assets/css/bootstrapss.min.css">
	    
	    <!-- Customizable CSS -->
	    <link rel="stylesheet" href="assets/css/mainx.css">
	    <link rel="stylesheet" href="assets/css/greens.css">
		...
		<link href="assets/css/greens.css" rel="alternate stylesheet" title="Green color">
...
<div id="hero" class="homepage-slider3 w-100">
	...
	<div class="info-boxes-inner">
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						<img src="./img/sub-banner1.jpg" alt="sub-1">
					</div>	
				</div>
			</div><!-- .col -->
			...
			<div class="info-box">
					<div class="row">
						<img src="./img/sub-banner2.jpg" alt="sub-2">
					</div>	
				</div>
			</div><!-- .col -->
			...
			<div class="info-box">
					<div class="row">
						<img src="./img/sub-banner3.jpg" alt="sub-3">
					</div>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<!-- ============================================== SCROLL TABS ============================================== -->
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp mt-5">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Sản phẩm phổ biến</h3>
			</div>

			<div class="tab-content outer-top-xs p-3">
