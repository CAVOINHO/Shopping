...
<div class="logo">
	<a href="index.php">
		<h2><i class="fas fa-store"></i> BRANCHY</h2>
	</a>
</div>		
</div>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php" class="form-inline">
        <div class="control-group">
            ...
            <input class="search-field form-control form-control-sm ml-3 w-75" placeholder="Tìm kiếm" name="product" required="required" />
			
            <button class="btn btn-info search-button" type="submit" name="search"><i class="fas fa-search" aria-hidden="true"></i></button>    
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">VND <?php echo ($row['productPrice']+$row['shippingCharge']); ?> x <?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total : <?php echo $_SESSION['tp']="$totalprice"; ?></span><span class='price'> VND</span>
