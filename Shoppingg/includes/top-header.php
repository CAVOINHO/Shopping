...
<?php if(strlen($_SESSION['login']))
    {   ?>
				<li><a href="#"><i class="fas fa-user-circle"></i> Xin chào - <?php echo htmlentities($_SESSION['username']);?></a></li>
				<?php } ?>

					<li><a href="my-account.php"><i class="fas fa-user-circle"></i> Tài Khoản</a></li>
